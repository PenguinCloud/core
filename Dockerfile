...
RUN pip3 install --no-cache-dir -r requirements.txt  && ansible-galaxy collection install community.general && pip install --no-cache-dir --upgrade pip>=21.1 urllib3>=1.26.5
